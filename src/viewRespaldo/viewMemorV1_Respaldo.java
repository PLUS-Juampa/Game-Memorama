package viewRespaldo;  // Paquete donde está guardada la clase del programa
...
public class viewMemorV1_Respaldo extends javax.swing.JFrame {
    ...
    private void MenuJ1() {   // Método que contiene el menú de opciones para mostrar cuando haya ganado el jugador1
        ...
        if (resp.equals("Reiniciar")) {   // Terminará e iniciará un juego nuevo
            ...
            viewMemorV1_Respaldo.main(null);
        }
...
//  Al hacer clic en el menú iniciar podrá desbloquear los componentes, e iniciar el programa
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewMemorV1_Respaldo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewMemorV1_Respaldo().setVisible(true);
            }
        });
